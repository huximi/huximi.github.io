...
layout: post
title: "RocketMQ入门"
subtitle: '一文搞懂 RabbitMQ 的重要概念以及安装'
author: "JavaGuide"
header-style: text
tags:    
    - RocketMQ
...
![图1-RabbitMQ 的整体模型架构](/img/distributed/96388546.jpg)
...
![Exchange(交换器) 示意图](/img/distributed/24007899.jpg)
...
![Binding(绑定) 示意图](/img/distributed/70553134.jpg)
...
![消息队列的运转过程](/img/distributed/67952922.jpg)
...
![direct 类型交换器](/img/distributed/37008021.jpg)
...
![topic 类型交换器](/img/distributed/73843.jpg)
...
![RabbitMQ 和 Erlang 的版本关系](/img/distributed/RabbitMQ-Erlang.png)
...
```
![输出“hello world”](/img/distributed/49570541.jpg)
...
![输入 erl 查看 erlang 环境变量是否配置正确](/img/distributed/62504246.jpg)
...
![RabbitMQ控制台](/img/distributed/45835332.jpg)
