...
![](/img/multi-thread/thread-local/1.png)
...
![](/img/multi-thread/thread-local/2.png)
...
![](/img/multi-thread/thread-local/3.png)
...
![](/img/multi-thread/thread-local/4.png)
...
![](/img/multi-thread/thread-local/8.png)
...
![](/img/multi-thread/thread-local/7.png)
...
![](/img/multi-thread/thread-local/12.png)
...
![](/img/multi-thread/thread-local/13.png)
...
![](/img/multi-thread/thread-local/14.png)
...
![](/img/multi-thread/thread-local/15.png)
...
![](/img/multi-thread/thread-local/16.png)
...
![](/img/multi-thread/thread-local/17.png)
...
![](/img/multi-thread/thread-local/18.png)
...
![](/img/multi-thread/thread-local/19.png)
...
![](/img/multi-thread/thread-local/24.png)

接着看看具体的`resize()`方法，为了方便演示，我们以`oldTab.len=8`来举例：

![](/img/multi-thread/thread-local/25.png)
...
![](/img/multi-thread/thread-local/26.png)

**第二种情况：** `slot`位置中的`Entry.key`和要查找的`key`不一致：

![](/img/multi-thread/thread-local/27.png)
...
![](/img/multi-thread/thread-local/28.png)
...
![](/img/multi-thread/thread-local/29.png)
