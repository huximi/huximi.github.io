...
![](/img/multi-thread/interview-questions/synchronized关键字.png)
...
![synchronized关键字原理](/img/multi-thread/synchronized关键字原理.png)
...
![ThreadLocal数据结构](/img/multi-thread/threadlocal数据结构.png)

`ThreadLocalMap`是`ThreadLocal`的静态内部类。

![ThreadLocal内部类](/img/multi-thread/ThreadLocal内部类.png)
...
![图解线程池实现原理](/img/multi-thread/java线程池学习总结/图解线程池实现原理.png)
