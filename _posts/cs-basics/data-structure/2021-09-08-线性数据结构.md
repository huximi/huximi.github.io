...
![单链表](/img/data/线性数据结构/单链表2.png)

#### 2.2.2. 循环链表

**循环链表** 其实是一种特殊的单链表，和单链表不同的是循环链表的尾结点不是指向 null，而是指向链表的头结点。

![循环链表](/img/data/线性数据结构/循环链表2.png)

#### 2.2.3. 双向链表

**双向链表** 包含两个指针，一个 prev 指向前一个节点，一个 next 指向后一个节点。

![双向链表](/img/data/线性数据结构/双向链表.png)

#### 2.2.4. 双向循环链表

**双向循环链表** 最后一个节点的 next 指向 head，而 head 的 prev 指向最后一个节点，构成一个环。

![双向循环链表](/img/data/线性数据结构/双向循环链表.png)
...
![栈实现浏览器倒退和前进](/img/data/线性数据结构/栈实现浏览器倒退和前进.png)
...
![顺序队列假溢出](/img/data/线性数据结构/顺序队列假溢出1.png)
...
![循环队列-队满](/img/data/线性数据结构/循环队列-堆满.png)
