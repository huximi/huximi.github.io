...
![物理机](/img/design/物理机图解.png)

**虚拟机：**

![虚拟机](/img/design/虚拟机图解.png)

**容器：**

![容器](/img/design/容器图解.jpg)
...
![Docker的一些概念](/img/design/v2-fcd40debf627c52dbd9bcbc5cd662512_r.jpg)
...
![容器 VS 虚拟机](/img/design/容器VS虚拟机.jpg)

### 3.2 容器与虚拟机总结

![容器与虚拟机 (VM) 总结](/img/design/容器与虚拟机总结.jpg)
...
![两者是可以共存的](/img/design/v2-1629eb3bca8a97ee18f02ae58113951c_r.jpg)
...
![docker基本概念](/img/design/docker基本概念.png)
...
![利用Docker Hub 搜索镜像](/img/design/Screen%20Shot%202019-11-04%20at%208.21.39%20PM.png)
...
![build ship run](/img/design/5c6941ffaddc1e16ebd53441da126afe.png)
...
- [可能是把Docker的概念讲的最清楚的一篇文章](http://www.imooc.com/article/39147 "可能是把Docker的概念讲的最清楚的一篇文章")
